...
//        {
//            throw new InvalidOperationException("Socket threw an exception because earlier a message was sent to the client after the client already closed the socket.", ex);
//        }
//        catch (SocketException ex) when (ex.SocketErrorCode == SocketError.TimedOut)
//        {
//            throw new TimeoutException("Did not receive a message from the client in a timely manner.", ex);
//        }
